        ...
        >
            ...
            >
                ...
                <div className="mb-6 space-y-4">
                    ...
                    <p>
                        <strong>CONTRATANTE:</strong> <strong>{project.clientName.toUpperCase()}</strong>, portador(a) do e-mail <strong>{project.email}</strong>, e inscrito(a) no CPF/CNPJ sob o nº <strong>{project.cpf || "______________________"}</strong>, doravante denominado(a) simplesmente CONTRATANTE.
                    </p>
