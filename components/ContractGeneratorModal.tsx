    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      >
        ...
        >
            ...
            <div id="contract-content" className="bg-white text-black mx-auto w-[210mm] print:w-full print:mx-0 print:p-[15mm] p-[20mm] shadow-2xl print:shadow-none font-sans text-[9.5pt] print:text-[9pt] leading-relaxed">
                
                {/* CABEÇALHO */}
                <div className="text-center mb-4 pb-2 border-b-2 border-black">
                    <h1 className="text-[11pt] font-bold uppercase mb-1">Contrato de Prestação de Serviços de</h1>
                    <h1 className="text-[11pt] font-bold uppercase">Desenvolvimento de Software</h1>
                </div>
                ...
                {/* CLÁUSULA 1 */}
                <h2 className="text-[9.5pt] font-bold uppercase mt-4 mb-2 pb-1 border-b border-gray-400">Cláusula 1ª - Do Objeto e Escopo</h2>
                <p className="mb-2 text-justify leading-tight">
                ...
                <ul className="list-disc ml-6 mb-3 space-y-1 text-[8.5pt]">
                    <li className="leading-tight">Codificação da Interface Gráfica (Layout) utilizando tecnologias web modernas (HTML, CSS, Javascript/React/Next.js).</li>
                    <li className="leading-tight">Estruturação de páginas e menus de navegação conforme briefing aprovado.</li>
                    <li className="leading-tight">Implementação de Responsividade (adaptação visual para celulares/tablets).</li>
                </ul>
                <p className="mb-2 leading-tight"><strong>1.2. EXCLUSÕES EXPRESSAS</strong> (O que NÃO será feito):</p>
                <ul className="list-disc ml-6 mb-3 space-y-1 text-[8.5pt]">
                    <li className="leading-tight"><strong>Integrações Funcionais:</strong> Configuração de gateways de pagamento, APIs de frete, emissão de nota fiscal ou lógica de vendas.</li>
                    <li className="leading-tight"><strong>Backend/Dados:</strong> Criação de banco de dados, painéis administrativos (dashboard), sistemas de login ou servidores.</li>
                    <li className="leading-tight">Inserção de conteúdo (textos/fotos) ou tratamento de imagens.</li>
                    <li className="leading-tight">Qualquer funcionalidade não descrita explicitamente na proposta inicial.</li>
                </ul>

                {/* CLÁUSULA 2 */}
                <h2 className="text-[9.5pt] font-bold uppercase mt-4 mb-2 pb-1 border-b border-gray-400">Cláusula 2ª - Dos Prazos, Aprovações e Validade</h2>
                <p className="mb-2 text-justify leading-tight">
                ...
                <p className="mb-3 text-justify leading-tight">
                ...
                {/* CLÁUSULA 3 */}
                <h2 className="text-[9.5pt] font-bold uppercase mt-4 mb-2 pb-1 border-b border-gray-400">Cláusula 3ª - Dos Valores e Blindagem de Pagamento</h2>
                <p className="mb-2 text-justify leading-tight">
                ...
                <p className="mb-3 text-justify leading-tight border border-black p-2">
                ...
                {/* CLÁUSULA 4 */}
                <h2 className="text-[9.5pt] font-bold uppercase mt-4 mb-2 pb-1 border-b border-gray-400">Cláusula 4ª - Da Limitação de Responsabilidade</h2>
                <p className="mb-2 text-justify leading-tight">
                    <strong>4.1.</strong> A CONTRATADA desenvolve a interface visual (Frontend). Não é de responsabilidade da CONTRATADA:
                </p>
                <ul className="list-disc ml-6 mb-3 space-y-1 text-[8.5pt]">
                    <li className="leading-tight">Falhas, lentidão ou queda de servidores de hospedagem contratados pelo CONTRATANTE.</li>
                    <li className="leading-tight">Erros em APIs de terceiros (Gateways de pagamento, Correios, etc.).</li>
                    <li className="leading-tight">Prejuízos financeiros decorrentes de "bugs" ou indisponibilidade do site.</li>
                    <li className="leading-tight">Segurança da informação (vazamento de dados) em servidores gerenciados por terceiros.</li>
                </ul>

                {/* CLÁUSULA 5 */}
                <h2 className="text-[9.5pt] font-bold uppercase mt-4 mb-2 pb-1 border-b border-gray-400">Cláusula 5ª - Da Rescisão e Multa Compensatória</h2>
                <p className="mb-2 text-justify leading-tight">
                ...
                {/* CLÁUSULA 6 */}
                <h2 className="text-[9.5pt] font-bold uppercase mt-4 mb-2 pb-1 border-b border-gray-400">Cláusula 6ª - Da Propriedade Intelectual</h2>
                <p className="mb-3 text-justify leading-tight">
                ...
                {/* CLÁUSULA 7 */}
                <h2 className="text-[9.5pt] font-bold uppercase mt-4 mb-2 pb-1 border-b border-gray-400">Cláusula 7ª - Do Foro</h2>
                <p className="mb-6 text-justify leading-tight">
                    Fica eleito o foro da comarca de <strong>Ceilândia - DF</strong>.
                </p>

                {/* DATA */}
                <p className="text-center italic text-[8.5pt] text-gray-600 mt-6 mb-12">
                ...
                <div className="grid grid-cols-2 gap-8 mt-16 pt-8">
                    ...
                    <div className="flex flex-col items-center">
                        <div className="w-full h-20 mb-2 flex items-center justify-center border-b border-black relative">
                            {adminSig && (
                                <img 
                                    src={adminSig} 
                        ...
                        <p className="font-bold text-[9pt] text-center">JOÃO PHILIPPE DE OLIVEIRA BOECHAT</p>
                        <p className="text-[7.5pt] uppercase tracking-wide text-center text-gray-600">CONTRATADA</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <p className="font-bold text-[9pt] text-center">{project.clientName.toUpperCase()}</p>
                        <p className="text-[7.5pt] uppercase tracking-wide text-center text-gray-600">CONTRATANTE</p>
                    </div>
                </div>
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-[#1A1D24] flex justify-end items-center gap-3 print:hidden shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] z-10">
            ...
            <div className="flex gap-2 ml-2 pl-2 border-l border-gray-200 dark:border-gray-700">
                ...
                <Button variant="outline" onClick={handlePrint} className="border-gray-300 hover:bg-gray-100" leftIcon={<Download size={16}/>}>
                    Salvar PDF
                </Button>
            </div>
        </div>
